...
public class link_name implements _baseNode {
  public int _line = -1;
  public int _col = -1;
  ...
  public org.antlr.runtime.tree.Tree unparse() {
    org.antlr.runtime.CommonToken _token = new org.antlr.runtime.CommonToken(ru.barsopen.plsqlconverter.PLSQLPrinter.LINK_NAME);
    _token.setLine(_line);
    _token.setCharPositionInLine(_col);
    _token.setText("LINK_NAME");
