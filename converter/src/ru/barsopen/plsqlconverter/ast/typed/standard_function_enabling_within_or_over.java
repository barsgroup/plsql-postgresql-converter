...
public class standard_function_enabling_within_or_over implements standard_function, _baseNode {
  public int _line = -1;
  public int _col = -1;
  ...
  public within_clause within_clause = null;
  public within_clause get_within_clause() { return this.within_clause; }
  public void set_within_clause(within_clause value) {
    if (this.within_clause != null) { this.within_clause._setParent(null); }
    this.within_clause = value;
    if (this.within_clause != null) { this.within_clause._setParent(this); }
  }
  public boolean is_within_clause() { return this.within_clause != null; }
  ...
  public void _walk(_visitor visitor) {
    ...
    if (this.within_clause != null) {
      this.within_clause._walk(visitor);
    }
  ...
  public void _replace(_baseNode child, _baseNode replacement) {
    ...
    if (this.within_clause == child) {
      this.set_within_clause((ru.barsopen.plsqlconverter.ast.typed.within_clause)replacement);
      return;
    }
  ...
  public org.antlr.runtime.tree.Tree unparse() {
    org.antlr.runtime.CommonToken _token = new org.antlr.runtime.CommonToken(ru.barsopen.plsqlconverter.PLSQLPrinter.FUNCTION_ENABLING_WITHIN_OR_OVER);
    ...
    if (within_clause != null) {
      _result.addChild(within_clause.unparse());
    }
