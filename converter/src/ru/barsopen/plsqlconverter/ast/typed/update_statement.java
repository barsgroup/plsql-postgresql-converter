...
public class update_statement implements data_manipulation_language_statements, _baseNode {
  ...
  public void _replace(_baseNode child, _baseNode replacement) {
    ...
    if (this.update_statement_set == child) {
      this.set_update_statement_set((ru.barsopen.plsqlconverter.ast.typed.update_statement_set)replacement);
      return;
    }
  ...
  public org.antlr.runtime.tree.Tree unparse() {
    org.antlr.runtime.CommonToken _token = new org.antlr.runtime.CommonToken(ru.barsopen.plsqlconverter.PLSQLPrinter.SQL92_RESERVED_UPDATE);
